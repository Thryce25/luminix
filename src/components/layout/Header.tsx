...
const collections = [
  {
    ...
    subcategories: [
      { name: 'View All', href: '/products?category=mens-essentials' },
      { name: 'Hoodie', href: '/products?category=mens-essentials&type=hoodie' },
      { name: 'Sweatshirt', href: '/products?category=mens-essentials&type=sweatshirt' },
      { name: 'T-Shirt', href: '/products?category=mens-essentials&type=t-shirt' },
      { name: 'Shirt', href: '/products?category=mens-essentials&type=shirt' },
      { name: 'Pants', href: '/products?category=mens-essentials&type=pants' },
    ],
  },
  {
    name: 'New Arrivals',
    ...
    subcategories: [
      { name: 'View All', href: '/products?category=new-arrivals' },
      { name: 'Hoodie', href: '/products?category=new-arrivals&type=hoodie' },
      { name: 'Sweatshirt', href: '/products?category=new-arrivals&type=sweatshirt' },
      { name: 'T-Shirt', href: '/products?category=new-arrivals&type=t-shirt' },
      { name: 'Shirt', href: '/products?category=new-arrivals&type=shirt' },
      { name: 'Pants', href: '/products?category=new-arrivals&type=pants' },
    ],
  },
  {
    ...
    subcategories: [
      { name: 'View All', href: '/products?category=womens-essentials' },
      { name: 'T-Shirt', href: '/products?category=womens-essentials&type=t-shirt' },
      { name: 'Top', href: '/products?category=womens-essentials&type=top' },
      { name: 'Hoodie', href: '/products?category=womens-essentials&type=hoodie' },
      { name: 'Sweatshirt', href: '/products?category=womens-essentials&type=sweatshirt' },
    ],
  },
  {
    name: 'Shop All',
...
export default function Header() {
  ...
  return (
    <>
      <header className="sticky top-8 left-0 right-0 z-40 bg-black/95 backdrop-blur-md border-b border-deep-purple/30">
      ...
      >
        ...
        >
          ...
          <div className={`relative flex items-center justify-between px-6 py-5 transition-all duration-500 ${mobileMenuOpen ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'}`}>
            <Link href="/" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 touch-manipulation">
              <img 
                src="/images/Luminix symbol - white.svg" 
                alt="Luminix Logo" 
