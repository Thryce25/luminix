...
const collections = [
  {
    ...
    categories: [
      { name: 'Hoodies', href: '/products?category=mens-essentials&type=Hoodie' },
      { name: 'Sweatshirts', href: '/products?category=mens-essentials&type=Sweatshirt' },
      { name: 'T-Shirts', href: '/products?category=mens-essentials&type=T-Shirt' },
    ],
  },
  {
    id: 2,
    ...
    categories: [
      { name: 'All New', href: '/products?category=new-arrivals' },
      { name: 'Hoodies', href: '/products?category=new-arrivals&type=Hoodie' },
      { name: 'T-Shirts', href: '/products?category=new-arrivals&type=T-Shirt' },
    ],
  },
  {
    id: 3,
    ...
    categories: [
      { name: 'Boyfriend Tees', href: '/products?category=womens-essentials&type=T-Shirt' },
      { name: 'Tops', href: '/products?category=womens-essentials&type=Top' },
      { name: 'All', href: '/products?category=womens-essentials' },
    ],
  },
];
