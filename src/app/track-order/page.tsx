  ...
  return (
    <div className="min-h-screen bg-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className={`relative mx-auto w-24 h-24 mb-8 transition-all duration-700 delay-100 ${isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <div className="absolute inset-0 bg-linear-to-br from-blue-500/30 to-burnt-lilac/20 rounded-2xl rotate-6 animate-pulse" />
              <div className="absolute inset-0 bg-linear-to-br from-deep-purple/80 to-blue-900/50 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/10">
            ...
            <h1 className={`text-4xl sm:text-5xl md:text-6xl font-serif mb-4 transition-all duration-700 delay-200 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <span className="bg-linear-to-r from-white via-blue-200 to-burnt-lilac bg-clip-text text-transparent">
                Track Your Order
              </span>
            </h1>
          ...
          <div className={`bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6 sm:p-8 transition-all duration-700 delay-400 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full py-4 bg-linear-to-r from-blue-500 to-burnt-lilac rounded-xl text-white font-medium hover:shadow-lg hover:shadow-blue-500/30 hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSearching ? (
                  <>
      ...
      <section className="relative z-10 py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-8 sm:left-1/2 top-0 bottom-0 w-px bg-linear-to-b from-blue-500/50 via-burnt-lilac/50 to-mist-lilac/20" />

            {orderStatuses.map((item, index) => (
              <div
                key={item.id}
                className={`relative flex items-center mb-8 sm:mb-12 transition-all duration-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-5'}`}
                style={{ transitionDelay: `${600 + index * 100}ms` }}
              >
                {/* Timeline Dot */}
                <div className="absolute left-8 sm:left-1/2 w-4 h-4 -ml-2 bg-linear-to-r from-blue-500 to-burnt-lilac rounded-full shadow-lg shadow-blue-500/30" />
                ...
                <div className={`ml-20 sm:ml-0 ${index % 2 === 0 ? 'sm:mr-[calc(50%+2rem)] sm:text-right' : 'sm:ml-[calc(50%+2rem)]'} flex-1`}>
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6 hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 group">
                    <div className={`flex items-center gap-3 ${index % 2 === 0 ? 'sm:justify-end' : ''}`}>
                      <div className="w-10 h-10 rounded-lg bg-linear-to-br from-blue-500/20 to-burnt-lilac/20 flex items-center justify-center group-hover:scale-110 transition-transform">
      ...
      <section className="relative z-10 py-12 pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-linear-to-br from-blue-900/20 to-burnt-lilac/10 rounded-2xl border border-white/10 p-8 text-center transition-all duration-700 delay-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/contact" className="px-6 py-3 bg-linear-to-r from-blue-500 to-burnt-lilac rounded-xl text-white font-medium hover:shadow-lg hover:shadow-blue-500/30 hover:scale-105 transition-all duration-300">
                Contact Support
              </Link>
