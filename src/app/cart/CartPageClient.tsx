      ...
      <section className="relative pt-24 pb-12 sm:pt-32 sm:pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              <div className="absolute inset-0 bg-linear-to-br from-burnt-lilac/30 to-mist-lilac/20 rounded-2xl rotate-6 animate-pulse" />
              <div className="absolute inset-0 bg-linear-to-br from-deep-purple/80 to-burnt-lilac/50 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/10">
            ...
            >
              <div className="h-px w-16 bg-linear-to-r from-transparent to-burnt-lilac/50" />
              <div className="w-2 h-2 rounded-full bg-burnt-lilac animate-pulse" />
              <div className="h-px w-16 bg-linear-to-l from-transparent to-burnt-lilac/50" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link 
                href="/products" 
                className="group relative px-8 py-3 bg-linear-to-r from-burnt-lilac to-purple-600 rounded-xl text-white font-medium overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-burnt-lilac/30 hover:scale-105"
              >
